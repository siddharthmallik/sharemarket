...
public class LoginActivity extends AppCompatActivity {
    ...
    public void openRegister(View v) {
        Intent i = new Intent(this, com.example.nit.sharestockmarket.RegisterActivity.class);
        startActivity(i);
    }
    ...
    public void validateUser(View v) {
        ...
        if (uname.isEmpty()) {
            ...
            if (pass.isEmpty()) {
                ...
                com.example.nit.sharestockmarket.MyDatabase md = new com.example.nit.sharestockmarket.MyDatabase(this);
                ...
                if (res) {
                    ...
                    if (db_pass.equals(pass)) {
                        finish();
                        Intent i = new Intent(this, com.example.nit.sharestockmarket.MainActivity.class);
                        i.putExtra("k1", uname);
                        startActivity(i);
                    } else {
                        et2.requestFocus();
